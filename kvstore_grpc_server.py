...
class KVStoreServicer(kvstore_pb2_grpc.KVStoreServicer):
    ...
    def __init__(self, shard_cnt, replica_cnt, storage_loc, print_req):
...
if __name__ == '__main__':
    ...
    kvstore_pb2_grpc.add_KVStoreServicer_to_server(KVStoreServicer(args.shard_cnt, args.replica_cnt, args.storage_loc, args.print_req), server)
